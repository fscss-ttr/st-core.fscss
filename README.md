...
st-core is implemented entirely in CSS/FSCSS, following the same **FSCSS plugin logic** as libraries like the [Circle Progress component](https://github.com/Figsh/Circle-progress.fscss). All behavior comes from FSCSS directives and CSS variables.
